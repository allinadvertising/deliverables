...
| Kickoff decks | `/kickoff/toico`, `/kickoff/toico/v2`, `/kickoff/penelope/v2`, `/kickoff/intradyn/v2`, `/kickoff/race-parts-solutions/v2`, `/kickoff/88-gear/v2`, `/kickoff/sportsdisplays` | `src/lib/kickoff/*.ts`; V2 decks typed by `kickoff/v2-types.ts` | `components/kickoff/*`, `components/kickoff/v2/*` |
