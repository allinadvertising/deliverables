...
| Kickoff decks | `/kickoff/toico`, `/kickoff/toico/v2`, `/kickoff/penelope/v2`, `/kickoff/sportsdisplays` | `src/lib/kickoff/*.ts`; V2 decks typed by `kickoff/v2-types.ts` | `components/kickoff/*`, `components/kickoff/v2/*` |
