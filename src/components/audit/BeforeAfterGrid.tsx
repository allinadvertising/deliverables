      ...
      {pairs.map((pair, i) => (
        <div className="mb-8 last:mb-0" key={i}>
          ...
          <div className="grid grid-cols-2 gap-6 max-lg:grid-cols-1">
            <div className="audit-card border-[#ffc9c9] bg-[linear-gradient(180deg,#ffffff_0%,#fffafa_100%)] p-6">
            ...
            <div className="audit-card border-[#a7d9a7] bg-[linear-gradient(180deg,#ffffff_0%,#f8fff9_100%)] p-6">
