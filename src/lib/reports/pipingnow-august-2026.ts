...
export const pipingNowAugust2026Report: SeoStoryReportData = {
  ...
  meta: {
    action:
      "Finish the cross-source measurement reconciliation (Search Console, Merchant Center, GA4, Google Ads, Shopify) so organic revenue reports cleanly, then measure September's recrawl against August's URL fixes and start category recovery on ProPress and pipe hangers.",
    client: "Piping Now",
    coverHeadline:
  ...
  executiveSummary:
    "The bottom line: August is the Month-1 baseline — organic traffic is down, store revenue held flat, and the fixes that should reverse the decline shipped late in the month, so their effect shows in September, not August. Organic clicks fell 28.6% to 7,245 and impressions 11.9% to 861,923 (average position 10.0 to 11.8); nearly all of that is non-brand, the traffic we are here to grow. Two things point up: the pipe-to-metric conversion chart — the biggest loser in the onboarding audit — recovered (+89 clicks, +24,484 impressions), and the developer shipped the core crawl-cleanup (canonical product URLs, removed parameter links, removed 301 hops). Store revenue was flat ($572,293 vs $572,711) on fewer but larger orders; the search channel fell about 19%, offset by growth in branded and direct orders. One caveat that sets the next step: Shopify's 'search' revenue mixes organic and paid Google (Piping Now runs Google Ads), so a clean organic-only revenue figure is not possible yet — separating the two is the P0 measurement work, and the next report resolves it.",
  ...
  powerLines: [
    ...
    },
    {
      area: "Revenue",
      statement:
        "Total store revenue held flat ($572,293, -0.1%); the search channel softened about 19% in line with organic traffic, offset by branded and direct growth. A clean organic figure is the P0 still in progress.",
      status: "watch",
    },
    {
      area: "Rankings",
      statement:
        "Average position eased from 10.0 to 11.8. Priority category pages (ProPress, pipe hangers, clevis hanger) are gaining impressions but losing clicks — a fixable click-through problem, not disappearance.",
      status: "watch",
    },
    {
  ...
  journeyWorkstreams: [
    ...
    },
    {
      ...
      work:
        "We completed the data-consolidation pass and built the Shopify revenue view, and confirmed that Shopify's 'search' referrer blends organic and paid Google because Piping Now runs Google Ads.",
      result:
        "Store revenue now has a clear all-channel baseline, but a clean organic-only figure still needs organic separated from paid across the five sources — so this report treats revenue as a baseline, not an organic result.",
      next:
        "Finish the GA4, Google Ads, and Shopify reconciliation, agree a reference number per metric, and report a clean organic revenue figure next month.",
    },
    {
      businessPriority:
      ...
      result:
        "The pipe-to-metric conversion chart gained 89 clicks and 24,484 impressions; the priority categories are being shown more but clicked less — a fixable click-through problem.",
      next:
  ...
  kpiRows: [
    {
      ...
      change: "-28.6%",
      businessMeaning:
        "Fewer organic visits — the post-migration decline the recovery plan targets. The fixes that address it shipped this month and take effect in September.",
      status: "watch",
    },
    {
  ...
  conversionPlan: {
    ...
    sourcePriority:
      "Finish the reconciliation across Search Console, Merchant Center, GA4, Google Ads, and Shopify, and agree a reference number per metric — the key step is isolating organic from paid search so 'search/google' revenue can be split cleanly.",
  ...
  obstacles: [
    ...
    },
    {
      ...
      remediation:
        "Finish the reconciliation across Search Console, Merchant Center, GA4, Google Ads, and Shopify and agree a reference number per metric.",
  ...
  technicalItems: [
    ...
    },
    {
      ...
      why:
        "The pages that carry commercial traffic are being shown more but clicked less — click-through and position erosion on the highest-value categories.",
      fix:
